...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    /**
     * @fileoverview Templates in namespace Playground.
     * @public
     */

    goog.module('Playground.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_close('div');
      ie_open('div', null, null, 'class', 'row');
      ie_open('div', null, null, 'class', 'metal-playground-pane col-md-12');
      ie_open('div', null, null, 'class', 'metal-playground-header');
      itext('Result');
      ie_close('div');
      ie_void('div', null, null, 'class', 'metal-playground-content metal-playground-result-content');
      ie_close('div');
      ie_close('div');
      ie_close('div');
    }
    ...
    if (goog.DEBUG) {
      $render.soyTemplateName = 'Playground.render';
    }
     ...
     * @suppress {checkTypes}
     */
    function $pane(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_close('div');
      ie_void('div', null, null, 'class', 'metal-playground-content metal-playground-' + type + '-content');
      ie_close('div');
    }
    exports.pane = $pane;
    if (goog.DEBUG) {
      $pane.soyTemplateName = 'Playground.pane';
    }
     ...
     * @suppress {checkTypes}
     */
    function $result(opt_data, opt_ignored, opt_ijData) {
      ie_open('iframe');
      ...
      ie_close('meta');
      ie_open('title');
      itext('Playground result');
      ie_close('title');
      ie_open('link', null, null, 'rel', 'stylesheet', 'href', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css');
      ie_close('link');
      ie_void('script', null, null, 'src', 'https://metal.github.io/metal.js-standalone/bin/babel.bundle.js');
      ie_void('style');
      ie_close('head');
      ie_void('body');
      ie_close('html');
    ...
    if (goog.DEBUG) {
      $result.soyTemplateName = 'Playground.result';
    }
     ...
     * @suppress {checkTypes}
     */
    function $tmp(opt_data, opt_ignored, opt_ijData) {
      ie_open('link', null, null, 'rel', 'stylesheet', 'href', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css');
      ie_close('link');
      ie_void('script', null, null, 'src', 'https://metal.github.io/metal.js-standalone/bin/babel.bundle.js');
      ie_void('script', null, null, 'src', 'https://metal.github.io/metal.js-standalone/bin/metal.bundle.js');
    }
    exports.tmp = $tmp;
    if (goog.DEBUG) {
      $tmp.soyTemplateName = 'Playground.tmp';
    }

    exports.render.params = ["type", "title"];
    exports.render.types = { "type": "string", "title": "string" };
    exports.tmp.params = [];
    exports.tmp.types = {};
    templates = exports;
    return exports;
  ...
  var Playground = function (_Component) {
    babelHelpers.inherits(Playground, _Component);

    function Playground() {
      babelHelpers.classCallCheck(this, Playground);
      return babelHelpers.possibleConstructorReturn(this, (Playground.__proto__ || Object.getPrototypeOf(Playground)).apply(this, arguments));
    }
  ...
  this['metalNamed']['Playground'] = this['metalNamed']['Playground'] || {};
  this['metalNamed']['Playground']['Playground'] = Playground;
  this['metalNamed']['Playground']['templates'] = templates;
  this['metal']['Playground'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  */
	...
	var Sample = function (_State) {
		babelHelpers.inherits(Sample, _State);

		function Sample(opt_config, opt_obj, opt_context) {
			babelHelpers.classCallCheck(this, Sample);

			var _this = babelHelpers.possibleConstructorReturn(this, (Sample.__proto__ || Object.getPrototypeOf(Sample)).call(this, opt_config, opt_obj, opt_context));

			_this.load();
			return _this;
		}

		babelHelpers.createClass(Sample, [{
			key: 'load',
			value: function load() {
				var that = this;

				var baseUrl = this.sampleRootUrl + "/" + this.sampleDirName + "/" + this.sampleDirName + ".";

				if (baseUrl.length > 3) {
					['js', 'css', 'html'].forEach(function (e) {
						Ajax.request(baseUrl + e, 'GET').then(function (xhr) {
...
(function () {
	...
	var Sample = this['metal']['Sample'];
	var State = this['metalNamed']['state']['State'];
	var validators = this['metalNamed']['state']['validators'];
	var Ajax = this['metal']['Ajax'];

	var SampleList = function (_State) {
		babelHelpers.inherits(SampleList, _State);

		function SampleList(opt_config, opt_obj, opt_context) {
			babelHelpers.classCallCheck(this, SampleList);

			var _this = babelHelpers.possibleConstructorReturn(this, (SampleList.__proto__ || Object.getPrototypeOf(SampleList)).call(this, opt_config, opt_obj, opt_context));

			_this.load();
			_this.select = new Select({ items: [], values: [], label: 'Samples' }, _this.element);
			return _this;
		}
		...
		babelHelpers.createClass(SampleList, [{
			...
			value: function load() {
				...
				if (url.length > this.indexFileName.length + 1) {
					Ajax.request(url, 'GET').then(function (xhr) {
  ...
  */
   ...
   */
	...
	this['metal']['SampleList'] = SampleList;
}).call(this);
'use strict';

(function () {
	var core = this['metal']['metal'];
	var templates = this['metal']['Playground'];
	var Component = this['metal']['component'];
	var Soy = this['metal']['Soy'];
	var dom = this['metal']['dom'];
	var Ajax = this['metal']['Ajax'];
	...
	var Alert = this['metal']['Alert'];
	var Modal = this['metal']['Modal'];
